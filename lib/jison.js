...
_handle_error:
        ...
        switch (action[0]) {
            ...
            stack.push(action[1]);
            if (typeof self.Jison !== 'undefined' && self.Jison.parserDebugger) {
                self.Jison.parserDebugger.push({
                    action: 'shift',
                    text: lexer.yytext,
                    loc: lexer.yylloc,
		...
		if (len && typeof self.Jison !== 'undefined' && self.Jison.parserDebugger) {
            ...
            case 3:
	            if (typeof self.Jison !== 'undefined' && self.Jison.parserDebugger) {
	                self.Jison.parserDebugger.push({ action: 'accept' });
	                console.log(self.Jison.parserDebugger[self.Jison.parserDebugger.length - 1]);
	            }
                return true;
        }
